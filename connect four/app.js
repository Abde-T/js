...
function checkBoard(){
    for(let i =0; i<winningArrays.length; i++){
        ...
        //check those squre to see if they all have the class of player-one
        ...
        //check those squre to see if they all have the class of player-two
...
for(let i = 0; i< squares.length; i++){
    squares[i].onclick = () =>{
       //if the squre bellow you current squre is taken you cqn go on top of it
